...
%Run PG
[u_prox,F_prox_subopt,e1,e2,u0,k]=lassompc_iprox(A_hat, b_hat, n, N, gamma,L,MAX_ITER,ABSTOL,lambda,delta,epsilon_0);
F_opt = objective(u_prox(:));

% % Run Maximum Hands-off MPC
% [u_prox,F_prox_subopt,e1,e2,u0,k]=maxhfmpc_iprox(A_hat, b_hat, n, N, gamma,L,MAX_ITER,ABSTOL,lambda,delta,epsilon_0);
% F_opt = objective(u_prox(:));
